...
app.use("/:tenantSlug/collections", collections_1.default);
app.use("/:tenantSlug/api-keys", extras_1.apiKeysRouter);
app.use("/:tenantSlug/webhooks", extras_1.webhooksRouter);
app.use("/:tenantSlug/functions", extras_1.edgeFunctionsRouter);
app.use("/:tenantSlug/notifications", extras_1.notificationsRouter);
app.use("/:tenantSlug/analytics", extras_1.analyticsRouter);
// Root
app.get("/", (req, res) => {
  res.json({
...
async function start() {
  try {
    ...
    logger_1.logger.warn(
      "⚠️  Starting server without confirmed DB connection — will retry on requests",
    );
  }
